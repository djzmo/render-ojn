...
| --- | --- | --- |
| libsndfile | in-memory sample decode and Vorbis output | LGPL-2.1-or-later |
| LAME | MP3 encoding | LGPL-2.0-or-later |
| TagLib | audio metadata | LGPL-2.1-or-later/MPL-1.1 |
